...
$unit_arr = array();
  $c = "SELECT *,a.id as id FROM tb_menu as a inner join tb_type as b on a.type = b.id  where sid = '{$_POST['sid']}' order by order_id";
  ...
  <table class="w3-table w3-bordered w3-striped">
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($rs['type']==3){?>
          <a href="index.php?m=manage_sub_menu&id=<?php echo $rs['id'];?>" class="w3-button w3-indigo w3-round">
