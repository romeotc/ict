...
</div><h3><?php echo $_SESSION["strEmail"]; ?></h3>
...
<input id="size" type="range" value="500" min="100" max="1000" step="50"><label for="fill">FILL</label>
...
<textarea id="text"><?php echo $_SESSION['strEmail']; ?></textarea><hr><label for="minversion">MIN VERSION:</label>
