...
?>
	...
	<input type="text" value="<?php echo $rs['id']; ?>" id="id_hw" name="id_hw">
	<input type="text" value="<?php echo $rs_file['id']; ?>" id="id" name="id">
	...
	<textarea id="comment"><?php echo $rs_file['comment']; ?></textarea><p><br>
