...
<div class="w3-container  w3-orange w3-cell"><h3>คำอธิบายรายวิชา
<?php if(isset($_GET['edit'])=='1'){ ?>
  <a class="w3-btn w3-red" href="index.php?m=couse">     ยกเลิก</a>
  <a id="save_edit" class="w3-btn w3-blue">บันทึก</a>
<?php }else{
		if($_SESSION["group_hw"] == "teacher"){
?>
  <a class="w3-btn w3-teal" href="index.php?m=couse&edit=1">     แก้ไข</a>
		<?php } } ?>
</h3>
</div>
